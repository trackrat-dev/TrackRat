...
git remote add origin git@github.com:bokonon1/TrackRat.git
...
Add to README.md:
```markdown
![Deploy Status](https://github.com/bokonon1/TrackRat/actions/workflows/deploy-webpage.yml/badge.svg)
```
...
5. ⏭️ Visit https://bokonon1.github.io/TrackRat/
