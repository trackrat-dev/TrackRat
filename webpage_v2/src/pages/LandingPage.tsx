...
// Shared shape/size for the two hero CTAs so they line up side by side.
const HERO_CTA_BASE =
  'inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-lg border-2 border-accent transition-colors shadow-lg';
    ...
    <div className="min-h-screen bg-background text-text-muted">
      ...
      <section className="px-6 pt-14 pb-12 text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-3 mb-4">
          <a
            ...
            className={`${HERO_CTA_BASE} bg-accent text-white hover:bg-accent/90`}
          >
          ...
          <Link
            to="/departures"
            className={`${HERO_CTA_BASE} bg-accent text-white hover:bg-accent/90 md:bg-transparent md:text-accent md:hover:bg-accent/10`}
          >
            Open the web app (beta) <span aria-hidden="true">→</span>
          </Link>
        </div>
      ...
      <section className="px-6 py-12 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          ...
          >
            <h3 className="font-semibold text-lg mb-2 text-text-primary">Open the web app</h3>
