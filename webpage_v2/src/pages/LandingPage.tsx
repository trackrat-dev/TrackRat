    ...
    <div className="min-h-screen bg-background text-text-muted">
      ...
      <section className="px-6 pt-14 pb-12 text-center max-w-3xl mx-auto">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-6 py-3 mb-4 rounded-xl bg-accent text-white font-semibold text-lg hover:bg-accent/85 transition-colors shadow-lg"
        >
