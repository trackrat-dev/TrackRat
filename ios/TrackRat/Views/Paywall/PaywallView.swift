            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 20) {
                        ...
                        Text("TrackRat predicts your track assignments before they\u{2019}re posted, forecasts delays at departure & arrival, and lets you subscribe to real-time alerts for Amtrak, NJ Transit, PATH, the subway, and more \u{2014} all in one place.")
                            .font(.subheadline)
