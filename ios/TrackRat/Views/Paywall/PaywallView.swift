            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 20) {
                        ...
                        Text("The app is free to use with one train system and one route alert. Subscribing unlocks multiple transit systems and unlimited alerts \u{2014} and helps me keep the servers running.")
                            .font(.subheadline)
                            .foregroundColor(.white.opacity(0.8))
                            .multilineTextAlignment(.leading)
                            .lineSpacing(4)
                        ...
                        Text("Please don't hesitate to reach out if you hit any issues or think of further improvements!")
                            .font(.subheadline)
                            .foregroundColor(.white.opacity(0.8))
                            .multilineTextAlignment(.leading)
                            .lineSpacing(4)
