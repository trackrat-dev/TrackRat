...
METRA_ROUTE_STATIONS: dict[str, tuple[str, ...]] = {
    # Union Station lines
    "BNSF": (
        "AURORA", "ROUTE59", "NAPERVILLE", "LISLE", "BELMONT", "MAINST-DG",
        "FAIRVIEWDG", "WESTMONT", "CLARNDNHIL", "WHINSDALE", "HINSDALE",
        "HIGHLANDS", "WESTSPRING", "STONEAVE", "LAGRANGE", "CONGRESSPK",
        "BROOKFIELD", "HOLLYWOOD", "RIVERSIDE", "HARLEM", "BERWYN",
        "LAVERGNE", "CICERO", "BNWESTERN", "HALSTED", "CUS",
    ),
    "HC": (
        "JOLIET", "LOCKPORT", "ROMEOVILLE", "LEMONT", "WILLOWSPRN", "SUMMIT", "CUS",
    ),
    "MD-N": (
        "FOXLAKE", "INGLESIDE", "LONGLAKE", "ROUNDLAKE", "GRAYSLAKE",
        "PRAIRIEXNG", "LIBERTYVIL", "LAKEFRST", "DEERFIELD", "LAKECOOKRD",
        "NBROOK", "NGLENVIEW", "GLENVIEW", "GOLF", "MORTONGRV", "EDGEBROOK",
        "FORESTGLEN", "MAYFAIR", "GRAYLAND", "HEALY", "WESTERNAVE", "CUS",
    ),
    "MD-W": (
        "BIGTIMBER", "ELGIN", "NATIONALS", "BARTLETT", "HANOVERP", "SCHAUM",
        "ROSELLE", "MEDINAH", "ITASCA", "WOODDALE", "BENSENVIL", "MANNHEIM",
        "FRANKLIN", "RIVERGROVE", "ELMWOODPK", "MONTCLARE", "MARS",
        "GALEWOOD", "HANSONPK", "GRAND-CIC", "WESTERNAVE", "CUS",
    ),
    "NCS": (
        "ANTIOCH", "LAKEVILLA", "ROUNDLKBCH", "NCSGRAYSLK", "PRAIRCROSS",
        "MUNDELEIN", "VERNON", "PRAIRIEVW", "BUFFGROVE", "WHEELING",
        "PROSPECTHG", "OHARE", "ROSEMONT", "SCHILLERPK", "FRANKLINPK",
        "RIVERGROVE", "WESTERNAVE", "CUS",
    ),
    "SWS": (
        "MANHATTAN", "LARAWAY", "179TH-SWS", "153RD-SWS", "143RD-SWS",
        "PALOSPARK", "PALOSHTS", "WORTH", "CHICRIDGE", "OAKLAWN",
        "ASHBURN", "WRIGHTWOOD", "CUS",
    ),
    # Ogilvie Transportation Center lines
    "UP-N": (
        "KENOSHA", "WINTHROP", "ZION", "WAUKEGAN", "NCHICAGO", "GRTLAKES",
        "LAKEBLUFF", "LKFOREST", "FTSHERIDAN", "HIGHWOOD", "HIGHLANDPK",
        "RAVINIA", "BRAESIDE", "GLENCOE", "HUBARDWOOD", "WINNETKA",
        "INDIANHILL", "KENILWORTH", "WILMETTE", "CENTRALST", "EVANSTON",
        "MAINST", "ROGERPK", "PETERSON", "RAVENSWOOD", "CLYBOURN", "OTC",
    ),
    "UP-NW": (
        "HARVARD", "WOODSTOCK", "CRYSTAL", "PINGREE", "CARY", "FOXRG",
        "BARRINGTON", "PALATINE", "ARLINGTNPK", "ARLINGTNHT", "MTPROSPECT",
        "CUMBERLAND", "DESPLAINES", "DEEROAD", "PARKRIDGE", "EDISONPK",
        "NORWOODP", "JEFFERSONP", "IRVINGPK", "CLYBOURN", "OTC",
    ),
    "UP-NW-MCHENRY": (
        "MCHENRY", "PINGREE", "BARRINGTON", "PALATINE", "ARLINGTNPK",
        "ARLINGTNHT", "MTPROSPECT", "CUMBERLAND", "DESPLAINES", "CLYBOURN", "OTC",
    ),
    "UP-W": (
        "ELBURN", "LAFOX", "GENEVA", "WCHICAGO", "WINFIELD", "WHEATON",
        "COLLEGEAVE", "GLENELLYN", "LOMBARD", "VILLAPARK", "ELMHURST",
        "BERKELEY", "BELLWOOD", "MELROSEPK", "MAYWOOD", "RIVRFOREST",
        "OAKPARK", "KEDZIE", "OTC",
    ),
    # LaSalle Street Station
    "RI": (
        "JOLIET", "NEWLENOX", "MOKENA", "HICKORYCRK", "TINLEY80TH",
        "TINLEYPARK", "OAKFOREST", "MIDLOTHIAN", "ROBBINS", "VERMONT",
        "PRAIRIEST", "123RD-BEV", "119TH-BEV", "115TH-BEV", "111TH-BEV",
        "107TH-BEV", "103RD-BEV", "99TH-BEV", "95TH-BEV", "91ST-BEV",
        "BRAINERD", "GRESHAM", "35TH", "LSS",
    ),
    # Millennium Station — 3 branches merging at different points
    "ME": (
        "UNIVERSITY", "RICHTON", "MATTESON", "211TH-UP", "OLYMPIA",
        "FLOSSMOOR", "HOMEWOOD", "CALUMET", "HAZELCREST", "HARVEY",
        "147TH-UP", "IVANHOE", "RIVERDALE", "KENSINGTN", "111TH-UP",
        "107TH-UP", "103RD-UP", "91ST-UP", "87TH-UP", "83RD-UP",
        "79TH-UP", "75TH-UP", "63RD-UP", "59TH-UP", "55-56-57TH",
        "51ST-53RD", "47TH-UP", "27TH-UP", "MCCORMICK", "18TH-UP",
        "MUSEUM", "VANBUREN", "MILLENNIUM",
    ),
    "ME-BI": (
        "BLUEISLAND", "BURROAK", "ASHLAND", "RACINE", "WPULLMAN",
        "STEWARTRID", "STATEST", "KENSINGTN", "111TH-UP", "107TH-UP",
        "103RD-UP", "91ST-UP", "87TH-UP", "83RD-UP", "79TH-UP",
        "75TH-UP", "63RD-UP", "59TH-UP", "55-56-57TH", "51ST-53RD",
        "47TH-UP", "27TH-UP", "MCCORMICK", "18TH-UP", "MUSEUM",
        "VANBUREN", "MILLENNIUM",
    ),
    "ME-SC": (
        "93RD-SC", "87TH-SC", "83RD-SC", "79TH-SC", "WINDSORPK",
        "SOUTHSHORE", "BRYNMAWR", "STONYISLND", "63RD-UP", "59TH-UP",
        "55-56-57TH", "51ST-53RD", "47TH-UP", "27TH-UP", "MCCORMICK",
        "18TH-UP", "MUSEUM", "VANBUREN", "MILLENNIUM",
    ),
}
