...
def upgrade() -> None:
    ...
    op.add_column('train_journeys', sa.Column('discovery_track', sa.String(5), nullable=True))
    op.add_column('train_journeys', sa.Column('discovery_station_code', sa.String(2), nullable=True))
