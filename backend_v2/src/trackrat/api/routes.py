...
async def get_route_history(
    ...
    data_source: str = Query(
        ..., description="Data source (NJT, AMTRAK, PATH, PATCO, LIRR, MNR, SUBWAY, MBTA)"
    ),
    ...
    valid_sources = ["NJT", "AMTRAK", "PATH", "PATCO", "LIRR", "MNR", "SUBWAY", "MBTA"]
...
async def get_route_congestion(
    ...
    data_source: str | None = Query(
        None,
        description="Filter by data source (NJT, AMTRAK, PATH, PATCO, LIRR, MNR, SUBWAY, MBTA)",
    ),
