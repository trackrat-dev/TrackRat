...
class TestJustInTimeUpdateService:
    ...
    def test_needs_refresh_hot_train_uses_tighter_staleness(
        self, jit_service, sample_journey
    ):
    ...
    def test_needs_refresh_non_hot_train_uses_normal_staleness(
        self, jit_service, sample_journey
    ):
    ...
    def test_needs_refresh_departed_train_uses_normal_staleness(
        self, jit_service, sample_journey
    ):
