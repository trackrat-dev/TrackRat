...
class TestNwkWtcHeadsignOverride:
    ...
    @pytest.mark.asyncio
    async def test_correct_headsign_not_overridden(self, collector, mock_session):
    ...
    @pytest.mark.asyncio
    async def test_non_nwk_wtc_color_not_overridden(self, collector, mock_session):
