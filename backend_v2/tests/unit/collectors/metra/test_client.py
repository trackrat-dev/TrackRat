...
class TestMetraClient:
    ...
    async def test_get_station_arrivals_filters_by_station(self, client):
        ...
        client._cache = [
            MetraArrival(
                station_code="CUS", gtfs_stop_id="CUS",
                trip_id="ME_ME2012_V1_B", route_id="ME", direction_id=1,
                headsign=None, arrival_time=datetime(2026, 3, 25, 10, 30, tzinfo=UTC),
                departure_time=None, delay_seconds=0, track=None,
            ),
            MetraArrival(
                station_code="AURORA", gtfs_stop_id="AURORA",
                trip_id="BNSF_BNSF1200_V1_A", route_id="BNSF", direction_id=0,
                headsign=None, arrival_time=datetime(2026, 3, 25, 11, 0, tzinfo=UTC),
                departure_time=None, delay_seconds=0, track=None,
            ),
        ]
        client._cache_time = datetime.now(UTC)
    ...
    async def test_get_trip_stops_filters_and_sorts(self, client):
        ...
        client._cache = [
            MetraArrival(
                station_code="AURORA", gtfs_stop_id="AURORA",
                trip_id="BNSF_BNSF1200_V1_A", route_id="BNSF", direction_id=0,
                headsign=None, arrival_time=datetime(2026, 3, 25, 10, 0, tzinfo=UTC),
                departure_time=None, delay_seconds=0, track=None,
            ),
            MetraArrival(
                station_code="NAPERVILLE", gtfs_stop_id="NAPERVILLE",
                trip_id="BNSF_BNSF1200_V1_A", route_id="BNSF", direction_id=0,
                headsign=None, arrival_time=datetime(2026, 3, 25, 10, 20, tzinfo=UTC),
                departure_time=None, delay_seconds=0, track=None,
            ),
            MetraArrival(
                station_code="CUS", gtfs_stop_id="CUS",
                trip_id="BNSF_BNSF1200_V1_A", route_id="BNSF", direction_id=0,
                headsign=None, arrival_time=datetime(2026, 3, 25, 10, 50, tzinfo=UTC),
                departure_time=None, delay_seconds=0, track=None,
            ),
            MetraArrival(
                station_code="CUS", gtfs_stop_id="CUS",
