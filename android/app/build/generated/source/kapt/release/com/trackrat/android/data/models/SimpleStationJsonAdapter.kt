...
public class SimpleStationJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<SimpleStation>() {
  ...
  public override fun toString(): String = buildString(35) {
      append("GeneratedJsonAdapter(").append("SimpleStation").append(')') }

  public override fun fromJson(reader: JsonReader): SimpleStation {
  ...
  public override fun toJson(writer: JsonWriter, value_: SimpleStation?): Unit {
    if (value_ == null) {
