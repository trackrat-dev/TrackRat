# TrackRat Android - Design Documentation

This document contains detailed design specifications, implementation details, and reference documentation for the TrackRat Android application. For essential development information, see `CLAUDE.md`.
...
### Time Handling (`ZonedDateTimeAdapter.kt`)
```kotlin
