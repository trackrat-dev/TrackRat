...
def plot_learning_curves(
    ...
    ax1.plot(epochs, train_losses, 'o-', color=COLORS['primary'], linewidth=2,
    ...
    if val_losses and len(val_losses) > 0:
        ...
        ax1.plot(val_epochs, val_losses, 'o-', color=COLORS['secondary'], linewidth=2,
    ...
    if val_accuracies and len(val_accuracies) > 0:
        ...
        ax2.plot(val_epochs, val_accuracies, 'o-', color=COLORS['accent'], linewidth=2,
